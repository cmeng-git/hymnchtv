...
public class FileBackend
{
    ...
    public static File getOutputMediaFile(int type)
    {
        ...
        if (type == MEDIA_TYPE_IMAGE) {
            mediaFile = new File(hymnchtvMediaDir, "IMG_" + timeStamp + ".jpg");
        }
        else if (type == MEDIA_TYPE_VIDEO) {
            mediaFile = new File(hymnchtvMediaDir, "VID_" + timeStamp + ".mp4");
        }
        return mediaFile;
    }
